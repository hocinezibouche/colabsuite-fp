...
const Header = () => {
  ...
  "
    >
      ...
      >
        <Image src={Logo} alt="CollabSuite Logo" width={25} height={25} />
        <span
      ...
      >
        <Link href={"/login"}>
          <Button
            ...
            className="dark:text-white text-white p-1 hidden sm:block"
          >
            Login
          </Button>
        </Link>
        <Link href="/signup">
          <Button className="whitespace-nowrap bg-transparent border border-white bg-black text-white shadow-white">
            Sign Up
          </Button>
        </Link>
      </aside>
